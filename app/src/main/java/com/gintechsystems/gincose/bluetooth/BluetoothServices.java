...
public class BluetoothServices {
    ...
    public static final UUID CGMTestService = UUID.fromString("F8084532-849E-531C-C594-30F1F86A4EA5");
    ...
    public static final UUID Exchange = UUID.fromString("F8083536-849E-531C-C594-30F1F86A4EA5");
